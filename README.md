# The Search for Planet X - Client
...
You can play the game online at [planetx.508071.xyz/](https://planetx.508071.xyz/) Or download the `apk`(for android) or `exe`(for windows) from the [releases page](https://github.com/EluvK/planetx_client/releases).
